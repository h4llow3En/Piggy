...
import type {RecurringPayment, RecurringPaymentCreate, RecurringPaymentUpdate} from '../api/piggy';
import {
...
const RecurringPaymentsPage: React.FC = () => {
    ...
    const handleOpen = (payment?: RecurringPayment) => {
        if (payment) {
                                ...
                                <Box sx={{
                                    ...
                                    <Box sx={{minWidth: 0, flex: 1}}>
                                        ...
                                        <Typography variant="body2" color="text.secondary"
                                            ...
                                            • {t('dashboard.recurring.nextDate')}: {format(getNextOccurrence(payment.start_date, payment.interval as RecurringInterval, payment.interval_x_days), 'dd.MM.yyyy')}
                                        </Typography>
                                    </Box>
